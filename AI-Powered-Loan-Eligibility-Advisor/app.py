...
# 💡 Paste the inline CSS block right after imports
st.markdown("""
    <style>
        /* 🌸 Main App Area */
        body {
        ...
        /* 🩵 Headings */
        h1, h2, h3, h4, h5, h6 {
            color: #0b2545 !important;  /* Deep navy headings */
        }

        /* 🌈 Paragraphs and General Text */
        p, div, span, li {
            color: #1a1a1a !important;  /* Force darker text for visibility */
            font-weight: 500;
        }

        /* 🌟 Make the main container text darker */
        [data-testid="stMain"] * {
        ...
        .stButton>button:hover {
            ...
            [data-baseweb="select"] {
                background-color: #f5f7fa !important;   /* soft pastel */
